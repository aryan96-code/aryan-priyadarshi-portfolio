...
export default function Education() {
  ...
  return (
    <section id="education" className="py-20 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto space-y-12">
      ...
      {/* Main Card */}
      <div className="rounded-2xl bg-[#0b101c] border border-slate-800 p-6 sm:p-10 space-y-6 shadow-xl relative overflow-hidden">
        <div className="flex flex-wrap items-start justify-between gap-4 border-b border-slate-800 pb-6">
          <div className="space-y-1">
            <span className="px-3 py-1 rounded bg-emerald-500/10 text-emerald-400 border border-emerald-500/30 text-xs font-mono font-semibold">
              Current Enrollment
            </span>
            <h3 className="text-2xl sm:text-3xl font-bold text-white tracking-tight pt-2">
              {education.institution}
            </h3>
            <p className="text-base font-semibold text-cyan-400">{education.degree}</p>
          </div>
